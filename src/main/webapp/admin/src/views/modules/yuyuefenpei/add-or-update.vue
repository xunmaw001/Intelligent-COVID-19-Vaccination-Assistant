<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="疫苗余量" prop="yimiaoyuliang">
          <el-input v-model="ruleForm.yimiaoyuliang" 
              placeholder="疫苗余量" clearable  :readonly="ro.yimiaoyuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="疫苗余量" prop="yimiaoyuliang">
              <el-input v-model="ruleForm.yimiaoyuliang" 
                placeholder="疫苗余量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.yimiaotupian" label="疫苗图片" prop="yimiaotupian">
          <file-upload
          tip="点击上传疫苗图片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.yimiaotupian?ruleForm.yimiaotupian:''"
          @change="yimiaotupianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.yimiaotupian" label="疫苗图片" prop="yimiaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.yimiaotupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分配说明" prop="fenpeishuoming">
          <el-input v-model="ruleForm.fenpeishuoming" 
              placeholder="分配说明" clearable  :readonly="ro.fenpeishuoming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分配说明" prop="fenpeishuoming">
              <el-input v-model="ruleForm.fenpeishuoming" 
                placeholder="分配说明" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiezhongdidian = true;
          ...
          if(o=='yimiaoyuliang'){
            this.ruleForm.yimiaoyuliang = obj[o];
	    this.ro.yimiaoyuliang = true;
            continue;
          }
          if(o=='yimiaotupian'){
	    ...
	    this.ro.fenpeishijian = true;
          ...
          if(o=='fenpeishuoming'){
            this.ruleForm.fenpeishuoming = obj[o];
	    this.ro.fenpeishuoming = true;
            continue;
          }
          if(o=='zhanghao'){
	...
	if(this.ruleForm.yimiaotupian!=null) {
		this.ruleForm.yimiaotupian = this.ruleForm.yimiaotupian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yuyuefenpei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yuyuefenpeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    yimiaotupianUploadChange(fileUrls) {
	this.ruleForm.yimiaotupian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
